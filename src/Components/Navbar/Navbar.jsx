  ...
  return (
    <>
      ...
      <div className="flex justify-around items-center">
        <div>
          <img className="h-28 w-full rounded-full" src={logo} alt="store"></img>
        </div>
        <div className="flex flex-row items-center">
          <div className="flex flex-row items-center">
            ...
            <p className=" font-inter text-base font-medium tracking-normal leading-none text-center mr-3">
              Wishlist
            </p>
          </div>
          <div
